...
export const flashSales: FlashSale[] = [
  {
    ...
    endTime: new Date("2025-06-22T10:00:00Z"),
    quantityLimit: 100,
    quantitySold: 20,
    isActive: true,
    priority: 1,
    ...
    updatedAt: new Date("2025-06-22T08:00:00Z"),
  },
  {
    id: 2,
    productId: 2,
    ...
    updatedAt: new Date("2025-06-22T09:00:00Z"),
  },
  {
    id: 3,
    productId: 3,
    ...
    endTime: new Date("2025-06-22T14:00:00Z"),
    quantityLimit: 50,
    quantitySold: 45,
    isActive: true,
    priority: 3,
    ...
    updatedAt: new Date("2025-06-22T12:01:00Z"),
  },
  {
    id: 4,
    productId: 4,
    ...
    updatedAt: new Date("2025-06-22T13:00:00Z"),
  },
  {
    id: 5,
    productId: 5,
    ...
    endTime: new Date("2025-06-22T18:00:00Z"),
    quantityLimit: 60,
    quantitySold: 10,
    isActive: true,
    priority: 5,
  ...
  },
  {
    ...
    endTime: new Date("2025-06-22T20:00:00Z"),
    quantityLimit: 90,
    quantitySold: 15,
    isActive: true,
    priority: 6,
  ...
  },
  {
    ...
    endTime: new Date("2025-06-22T22:00:00Z"),
    quantityLimit: 40,
    quantitySold: 5,
    isActive: true,
    priority: 7,
    ...
    updatedAt: new Date("2025-06-22T19:00:00Z"),
  },
  {
    id: 8,
    productId: 8,
    flashPrice: 375,
    startTime: new Date("2025-06-22T22:00:00Z"),
    ...
    priority: 8,
    bannerImage: "/fruit/tomato.png",
    createdAt: new Date("2025-06-21T18:00:00Z"),
    updatedAt: new Date("2025-06-22T21:00:00Z"),
  }
];
