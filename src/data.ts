...
export const flashSales: FlashSale[] = [
  {
    ...
    endTime: new Date("2025-06-28T10:00:00Z"),
    quantityLimit: 100,
    quantitySold: 20,
    isActive: true,
    priority: 1,
  ...
  },
  {
    ...
    endTime: new Date("2025-06-28T12:00:00Z"),
    quantityLimit: 80,
    quantitySold: 30,
    isActive: true,
    priority: 2,
  ...
  },
  {
    ...
    productId: 3,
    flashPrice: 370,
    startTime: new Date("2025-06-26T12:00:00Z"),
    endTime: new Date("2025-06-29T14:00:00Z"),
    quantityLimit: 50,
    quantitySold: 45,
    isActive: true,
    priority: 3,
  ...
  },
  {
    ...
    flashPrice: 375,
    startTime: new Date("2025-06-27T08:00:00Z"),
    endTime: new Date("2025-06-29T16:00:00Z"),
    quantityLimit: 70,
    quantitySold: 50,
    isActive: true,
    priority: 4,
    ...
    updatedAt: new Date("2025-06-27T13:00:00Z"),
  },
  {
    id: 5,
    productId: 5,
    flashPrice: 375,
    startTime: new Date("2025-06-2T16:00:00Z"),
    endTime: new Date("2025-06-27T18:00:00Z"),
    quantityLimit: 60,
    quantitySold: 10,
    isActive: true,
    priority: 5,
    ...
    updatedAt: new Date("2025-06-29T15:30:00Z"),
  },
  {
    id: 6,
    productId: 6,
    ...
    updatedAt: new Date("2025-06-29T18:00:00Z"),
  },
  {
    id: 7,
    productId: 7,
    flashPrice: 375,
    startTime: new Date("2025-06-27T20:00:00Z"),
    endTime: new Date("2025-06-28T22:00:00Z"),
    quantityLimit: 40,
    quantitySold: 5,
    isActive: true,
    priority: 7,
